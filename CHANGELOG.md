...
- Added project-scope notices for Kilo's global UI model cache plus an
  ...
  selection.
- Restored installer-managed `limit.output = 8192` after Kilo `7.2.0` oracle
  validation showed custom model entries fail without a numeric output limit.
...
## [0.8.0](https://github.com/GonkaGate/kilo-setup/compare/v0.7.1...v0.8.0) (2026-07-06)


### Features

* fetch GonkaGate models dynamically ([c959284](https://github.com/GonkaGate/kilo-setup/commit/c959284532dd87b0a11639033e7117efb67b4055))
...
* make Kimi K2.6 default and allow newer Kilo versions ([0b0267b](https://github.com/GonkaGate/kilo-setup/commit/0b0267bd2f804139f8cb102102bb5bdf4cfc8dc4))


### Bug Fixes

* stop pre-blocking newer kilo versions ([ec7c5a0](https://github.com/GonkaGate/kilo-setup/commit/ec7c5a0181601a96a168d353bb775ceba82cae81))
