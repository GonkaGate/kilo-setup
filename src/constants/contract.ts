export const CONTRACT_METADATA = {
  ...
  publicState:
    "Installer runtime is shipped with a validated curated Kimi K2.6 default for exact @kilocode/cli@7.2.0 installs, with installer-managed limit.output = 8192 for compatibility.",
