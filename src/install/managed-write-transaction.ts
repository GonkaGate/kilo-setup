...
export interface ManagedWriteTransaction {
  ...
  run<TResult extends ManagedArtifactWriteResult | undefined>(
    writeOperation: Promise<TResult>,
  ): Promise<TResult>;
  runAll<TResult extends readonly (ManagedArtifactWriteResult | undefined)[]>(
    writeOperation: Promise<TResult>,
  ): Promise<TResult>;
}
...
export function createManagedWriteTransaction(): ManagedWriteTransaction {
  ...
  function record(writeResult: ManagedArtifactWriteResult | undefined): void {
